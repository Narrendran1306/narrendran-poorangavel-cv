...
//         description:
//             "Led the end-to-end development of three integrated ERP modules including database design, API development, and front-end implementation.",
...
//         description:
//             "Developed an ERP module for employee shift scheduling, attendance management, and workflow optimization.",
...
//         description:
//             "Academic web application to manage donor records and emergency blood contact details.",
...
//         description:
//             "Academic project to manage and track books in libraries and institutions.",
